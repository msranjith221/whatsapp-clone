...
/* ADDED, DARK MODE - THIN SCROLLBAR */
@layer components {
	::-webkit-scrollbar {
		width: 8px;
	}
...
-   And create conversation.tsx, under /src/components/home/conversation.tsx
...
const Conversation = ({ conversation }: { conversation: any }) => {
	...
	const conversationName = conversation.groupName || "Two-Person Chat";
...
const RightPanel = () => {
	...
	const conversationName = "Person One";
